...
func (l *LRU) ResetDefault() {
	*l = LRU{
		...
		Patterns: []Pattern{
			"{\"_type\":\"Aurore\"}",
			"{\"Child\":{\"Frame\":\"Lff0000ff0000ff0000ff0000ff0000ffffffffffffffffffffffffffffff\",\"_type\":\"Repeated\"},\"MovesPerHour\":21600,\"_type\":\"Rotate\"}",
			...
			"{\"Child\":\"Lff0000ff0000ee0000dd0000cc0000bb0000aa0000990000880000770000660000550000440000330000220000110000\",\"MovesPerHour\":108000,\"_type\":\"PingPong\"}",
			...
			"\"#000000\"",
			"{\"Child\":\"Lffffff\",\"MovesPerHour\":108000,\"_type\":\"PingPong\"}",
