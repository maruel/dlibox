...
// BCM283x GPIO GPIO handling. It uses /dev/giomem for all access except for
// edge based triggering, which requires kernel cooperation to handle the
// interrupts generated by the CPU.
//
...
// from a file handle.
//
// The other downside of gpio sysfs, beside performance, is that it does not
