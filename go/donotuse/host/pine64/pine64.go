...
import (
	...
	"github.com/maruel/dlibox/go/donotuse"
	"github.com/maruel/dlibox/go/donotuse/conn/analog"
	"github.com/maruel/dlibox/go/donotuse/conn/gpio"
	"github.com/maruel/dlibox/go/donotuse/conn/pins"
	"github.com/maruel/dlibox/go/donotuse/host/allwinner"
	"github.com/maruel/dlibox/go/donotuse/host/allwinner_pl"
	"github.com/maruel/dlibox/go/donotuse/host/headers"
)
...
// driver implements donotuse.Driver.
type driver struct {
}
...
func (d *driver) Type() donotuse.Type {
	return donotuse.Pins
}
...
func init() {
	if isArm {
		donotuse.MustRegister(&driver{})
	} else {
		zapPins()
	}
}

var _ donotuse.Driver = &driver{}
