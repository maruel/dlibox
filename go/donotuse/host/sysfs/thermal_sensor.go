...
// driverThermalSensor implements donotuse.Driver.
...
func (d *driverThermalSensor) Type() donotuse.Type {
	return donotuse.Device
}
...
func init() {
	if isLinux {
		donotuse.MustRegister(&driverThermalSensor{})
	}
}
