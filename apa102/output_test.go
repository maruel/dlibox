...
func TestColorToAPA102(t *testing.T) {
	...
	data := []struct {
		...
		{anim1d.Color{0xFF, 0xFF, 0xFF, 0xFF}, col{0xFF, 0xFF, 0xFF, 0xFF}},
		{anim1d.Color{0x00, 0x00, 0x00, 0xFF}, col{0xE1, 0x00, 0x00, 0x00}},
		{anim1d.Color{0xFF, 0xFF, 0xFF, 0x00}, col{0xE1, 0x00, 0x00, 0x00}},
		{anim1d.Color{0xFF, 0x00, 0x00, 0xFF}, col{0xFF, 0x00, 0x00, 0xFF}},
		{anim1d.Color{0x00, 0xFF, 0x00, 0xFF}, col{0xFF, 0x00, 0xFF, 0x00}},
		{anim1d.Color{0x00, 0x00, 0xFF, 0xFF}, col{0xFF, 0xFF, 0x00, 0x00}},
	}
	for i, line := range data {
		var actual col
